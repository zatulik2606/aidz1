...
| Лид-система | `sqlite3` (`./data/leads.db`) | Фиксация заявок на консультацию (план итерации 13) |
...
- На текущем этапе (итерация 12) инструменты подключены как базовые заглушки; полноценная бизнес-логика — в итерациях 13–15.
...
- На текущем шаге инструменты работают в базовом режиме (заглушки), чтобы обеспечить устойчивый агентный цикл и трассировку.
