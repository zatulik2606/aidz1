...
class ConfigTests(unittest.TestCase):
    ...
    def test_load_config_fails_without_text_model(self, _mock_load_dotenv) -> None:
    ...
    def test_load_config_langsmith_defaults(self, _mock_load_dotenv) -> None:
        config = load_config()
    ...
    def test_load_config_supports_llm_model_fallback(self, _mock_load_dotenv) -> None:
        config = load_config()
    ...
    def test_load_config_supports_langchain_env_aliases(self, _mock_load_dotenv) -> None:
        config = load_config()
